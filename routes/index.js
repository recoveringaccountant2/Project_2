...
router.get('/oauth2callback', passport.authenticate(
  'google',
  {
    successRedirect : '/issues', // where do you want the client to go after you login 
    failureRedirect : '/accessdenied' // where do you want the client to go if login fails
  }
));
